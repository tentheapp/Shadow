...
//    _overlayView.leftBarButtonItem.imageInsets = NYTPhotosViewControllerCloseButtonImageInsets;
    ...
    UIImage *image = [[UIImage imageNamed:@"access-denied"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    UIBarButtonItem *_btn=[[UIBarButtonItem alloc]initWithImage: image
                                                          style:UIBarButtonItemStylePlain
                                                         target:self
                                                         action:@selector(doneButtonTapped:)];
    
    _overlayView.leftBarButtonItem =_btn ;
